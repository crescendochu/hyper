...
THREEx.HoleInTheWall.buildCircleCache = function(){
	...
	var mesh = new THREE.Mesh( geometry, material);
	mesh.renderOrder = -1 // ensure it is drawn first, thus z-buffer is full
	return mesh
}
...
// TODO here the cache should be a sphere
	...
	circleCache.renderOrder = -1 // ensure it is drawn first, thus z-buffer is full
